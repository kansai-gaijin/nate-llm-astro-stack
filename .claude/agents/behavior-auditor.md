...
Save screenshots, videos, and traces only under the active `artifacts/clone`,
`artifacts/adaptation`, or `artifacts/update/requests/<request-id>` subtree, never the project root.
